...
default_args = {
    'owner' : 'Jayama Chandran',
    'start_date' : days_ago(0),
    'email' : ['etljayama@gmail.com'],
...
extract_data_from_tsv = BashOperator(
    ...
    bash_command='cut -f5-7 /home/project/airflow/dags/finalassignment/tollplaza-data.tsv | tr -d "\r" | tr "[:blank:]" "," > /home/project/airflow/dags/finalassignment/staging/tsv_data.csv',
    dag=dag,
)
...
extract_data_from_fixed_width = BashOperator(
    ...
    bash_command='cut -c 59-67 /home/project/airflow/dags/finalassignment/payment-data.txt | tr " " "," > /home/project/airflow/dags/finalassignment/staging/fixed_width_data.csv',
    dag=dag,
)
